...
declare function xmlGcMemGet(
	freeFunc: interop.Pointer | interop.Reference<interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>) => void>>,
	mallocFunc: interop.Pointer | interop.Reference<interop.FunctionReference<(p1: number) => interop.Pointer | interop.Reference<any>>>,
	mallocAtomicFunc: interop.Pointer | interop.Reference<interop.FunctionReference<(p1: number) => interop.Pointer | interop.Reference<any>>>,
	reallocFunc: interop.Pointer | interop.Reference<interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: number) => interop.Pointer | interop.Reference<any>>>,
	strdupFunc: interop.Pointer | interop.Reference<interop.FunctionReference<(p1: string) => string>>
): number;
